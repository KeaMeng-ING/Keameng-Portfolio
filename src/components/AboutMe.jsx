    ...
    <div className="min-h-screen bg-black px-4 sm:px-8 md:px-12 lg:px-20 py-2 flex items-center justify-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl w-full items-center">
        ...
        >
          ...
          <button className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-500 border-purple-400 border-2 rounded-full px-8 py-2 mt-5 self-start hover:text-white transition duration-300">
            Download CV
          </button>
        </div>
      </div>
